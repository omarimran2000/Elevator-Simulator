...
public class TestConfig extends Config {
    ...
    public TestConfig(int type) throws IOException {
        ...
        if(type==0){
            dictionary.put("probabilityDoorStuck","75");
            dictionary.put("probabilityStuck","0");
    }else if(type==1){
            dictionary.put("probabilityDoorStuck","0");
            dictionary.put("probabilityStuck","75");
        }
        dictionary.put("dateFormatPattern","dd-MM-yyyy HH:mm:ss");
        dictionary.put("waitTime","1000");
        ...
        dictionary.put("checkIfStuckDelay","5");
    }
    /**
